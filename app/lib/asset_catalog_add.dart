...
class AssetCatalogAdd extends StatefulWidget {
  AssetCatalogAdd({
    super.key,
  });

  @override
  State<AssetCatalogAdd> createState() => _AssetCatalogAddState();
}

class _AssetCatalogAddState extends State<AssetCatalogAdd> {
  String code = '';
  String name = '';
  String description = '';
              ...
              child: Container(
                ...
                child: PrimaryButton(
                  ...
                  onPressed: () async {
                    ...
                    var res = await Api.catalog.add(item);
                    if (res == 0) return;
