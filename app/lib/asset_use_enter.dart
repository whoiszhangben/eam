...
class AssetUseEnter extends StatefulWidget {
  AssetUseEnter({
    super.key,
    required this.list,
  });
  ...
  @override
  State<AssetUseEnter> createState() => _AssetUseEnterState();
}

class _AssetUseEnterState extends State<AssetUseEnter> {
  bool inited = false;
  // 使用人
  String custodian = '';
  // 使用部门
  ...
  TextEditingController custodianController = TextEditingController();
                  ...
                  onPressed: () async {
                    ...
                    var items = list.map((item) {
                      return {
                        ...
                        'state': AssetStateEnum.use.index,
                    ...
                    await alert(context, '提交成功', '当前资产已成功领用');
