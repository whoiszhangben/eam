...
class AssetOrgAdd extends StatefulWidget {
  AssetOrgAdd({
    super.key,
    this.parent,
  });
  ...
  @override
  State<AssetOrgAdd> createState() => _AssetOrgAddState();
}

class _AssetOrgAddState extends State<AssetOrgAdd> {
  String code = '';
  String name = '';
  String description = '';
  ...
  Widget build(BuildContext context) {
    debugPrint('||| AssetOrgAdd parent\n${widget.parent}');
    return Scaffold(
      appBar: titleBar('新建机构'),
      body: Stack(
        fit: StackFit.expand,
        children: [
          ListView(
              ...
              child: Container(
                ...
                child: PrimaryButton(
                  ...
                  onPressed: () async {
                    ...
                    item['parent'] =
                        widget.parent != null ? widget.parent['id'] : null;
                    var res = await Api.organization.add(item);
                    if (res == 0) return;
