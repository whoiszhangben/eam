...
class AssetOrgEdit extends StatefulWidget {
  AssetOrgEdit({
    super.key,
    required this.item,
  });
  ...
  @override
  State<AssetOrgEdit> createState() => _AssetOrgEditState();
}

class _AssetOrgEditState extends State<AssetOrgEdit> {
  late var item;
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: PrimaryButton(
                  ...
                  onPressed: () async {
                    debugPrint('||| 提交 $item');
                    var res = await Api.organization.modify({
                      'id': item['id'],
                      'name': item['name'],
                      'code': item['code'],
                      'parent': item['parent'],
